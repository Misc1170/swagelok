...
for ($i = 0; $i < $count; $i++) :
    ...
    <div class="flex gap-x-4 items-center">
        <input class="pop_up__input w-7/12" type="text" placeholder="Код изделия" name="item-'.$i.'">
        <input class="pop_up__input  w-4/12" type="text" placeholder="Кол-во" name="count-'.$i.'">
